...
// Bookmarks — cross-app primitives (REV-3: collection kind dropped)
const BOOKMARKS = [
  ...
  { id: 'bm6', kind: 'thread',   ref: 'th_memoire_1', label: 'Mnemosyne ↔ Lethe symmetry', meta: 'thread · 4 msgs', when: 'this week' },
];
